...
class IniciarRondaUseCaseTest {
    ...
    void iniciarRonda(){
        ...
        when(repository.obtenerEventosPor("XXXX")).thenReturn(crearRonda());
    ...
    private Flux<DomainEvent> crearRonda() {
        var event = new JuegoCreado(JugadorId.of("FFFF"));
        event.setAggregateRootId("XXXX");

        var event2 = new TableroCreado(TableroId.of("TABLERO"), Set.of(JugadorId.of("Gianni"), JugadorId.of("Mati"), JugadorId.of("Joaco")));
